...
[![CI](https://github.com/Tsengel-de/ansible-role-dnsmasq/actions/workflows/ci.yml/badge.svg)](https://github.com/Tsengel-de/ansible-role-dnsmasq/actions/workflows/ci.yml)
...
Local domain name:
```yml
dnsmasq_domain_name: example.tsengel.de
```
